...
async function addProjectsWithAllFields() {
  console.log('🚀 Adding projects with all required fields...\n');

  try {
    // Add projects with all required fields
    const projects = [
      {
      ...
      },
      {
        ...
        style: "Hiện đại",
        html_content: "<div><h3>NHÀ PHỐ SANG TRỌNG - QUẬN 7</h3><p>Thiết kế nhà phố sang trọng tại Quận 7 với phong cách hiện đại.</p></div>",
      ...
      },
      {
        ...
        style: "Cổ điển",
        html_content: "<div><h3>BIỆT THỰ CỔ ĐIỂN - QUẬN 2</h3><p>Thiết kế biệt thự cổ điển tại Quận 2 với phong cách sang trọng.</p></div>",
      ...
      },
      {
        ...
        style: "Hiện đại",
        html_content: "<div><h3>SHOWROOM CAO CẤP - QUẬN 1</h3><p>Thiết kế showroom cao cấp tại Quận 1 với phong cách hiện đại.</p></div>",
    ...
    console.log('\n🎉 Database now has comprehensive project data!');
...
addProjectsWithAllFields().catch(console.error);
