...
router.post('/about-project', validateContentType, projectPageController.createAboutProjectData);

// PUT /api/v1/projectpage/about-project/:id - Update about project data
router.put('/about-project/:id', validateContentType, projectPageController.updateAboutProjectData);
...
router.post('/stats-section', validateContentType, projectPageController.createStatsSectionData);

// PUT /api/v1/projectpage/stats-section/:id - Update stats section data
router.put('/stats-section/:id', validateContentType, projectPageController.updateStatsSectionData);
...
router.put('/project-categories/:id', validateContentType, projectPageController.updateProjectCategoriesData);
