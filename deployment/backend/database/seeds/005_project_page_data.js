  ...
  await knex('stats_items').insert([
    {
      ...
      background_image_url: 'http://localhost:9000/pgdesign-assets/images/diary-image-1.jpg',
      category: 'experience',
      display_order: 0,
      is_active: true,
      created_at: new Date(),
    ...
    },
    {
      ...
      background_image_url: 'http://localhost:9000/pgdesign-assets/images/diary-image-2.jpg',
      category: 'customers',
      display_order: 1,
      is_active: true,
      created_at: new Date(),
    ...
    },
    {
      ...
      background_image_url: 'http://localhost:9000/pgdesign-assets/images/diary-image-3.jpg',
      category: 'projects',
      display_order: 2,
      is_active: true,
      created_at: new Date(),
    ...
    },
    {
      ...
      background_image_url: 'http://localhost:9000/pgdesign-assets/images/diary-image-4.jpg',
      category: 'quality',
      display_order: 3,
      is_active: true,
      created_at: new Date(),
