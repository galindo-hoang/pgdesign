...
export const fetchVisionMissionDataMock = async (): Promise<VisionMissionData> => {
  await mockDelay();
...
export const fetchVisionMissionDataApi = async (): Promise<VisionMissionData> => {
  try {
...
export const fetchVisionMissionData = async (): Promise<VisionMissionData> => {
  return USE_MOCK_DATA ? fetchVisionMissionDataMock() : fetchVisionMissionDataApi();
};
