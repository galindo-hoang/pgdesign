  ...
  htmlContent: `
    ...
    <div style="">
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1rem; margin-top: 1rem;">
        <img src='https://s3-hcm-r2.s3cloud.vn/pgdesign-new/images/diary-image-1.png' alt="Mặt tiền nhà" style="width: 100%; height: 200px; object-fit: cover; border-radius: 4px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
        <img src='https://s3-hcm-r2.s3cloud.vn/pgdesign-new/images/diary-image-2.png' alt="Phòng khách" style="width: 100%; height: 200px; object-fit: cover; border-radius: 4px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
        <img src='https://s3-hcm-r2.s3cloud.vn/pgdesign-new/images/diary-image-3.png' alt="Phòng bếp" style="width: 100%; height: 200px; object-fit: cover; border-radius: 4px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
        <img src='https://s3-hcm-r2.s3cloud.vn/pgdesign-new/images/diary-image-4.png' alt="Phòng ngủ" style="width: 100%; height: 200px; object-fit: cover; border-radius: 4px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
      </div>
    </div>
