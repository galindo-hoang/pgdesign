  ...
  sections: [
    {
      ...
      description:
        "Tư vấn chuyên sâu về phong cách, không gian và ngân sách. Thiết kế 3D chi tiết với nhiều phương án lựa chọn.",
    ...
    },
    {
      ...
      description:
        "Lập kế hoạch thi công chi tiết, dự toán ngân sách chính xác và lịch trình thực hiện rõ ràng.",
    ...
    },
    {
      ...
      description:
        "Thi công theo đúng thiết kế với đội ngũ thợ lành nghề. Giám sát chất lượng 24/7 đảm bảo tiến độ.",
    ...
    },
    {
      ...
      description:
        "Nghiệm thu từng hạng mục, đảm bảo chất lượng. Bàn giao công trình hoàn thiện với hướng dẫn sử dụng.",
      images: [
        architecturalImage11,
        architecturalImage12,
        architecturalImage13,
      ],
  ...
  phases: [
    {
      ...
      description:
        "Áp dụng công nghệ BIM và phần mềm thiết kế 3D tiên tiến để tạo ra bản vẽ chi tiết và chính xác.",
      images: [
        architecturalImage14,
        architecturalImage15,
        architecturalImage16,
      ],
    ...
    },
    {
      ...
      description:
        "Sử dụng vật liệu cao cấp, có nguồn gốc rõ ràng và đảm bảo tiêu chuẩn an toàn, bền vững.",
      images: [
        architecturalImage17,
        architecturalImage18,
        architecturalImage19,
        architecturalImage20,
      ],
...
export const fetchConstructionProcessData =
  async (): Promise<ConstructionProcessData> => {
    return fetchFromAPI(
      API_ENDPOINTS.CONSTRUCTION_PROCESS,
      mockConstructionProcessData
    );
  };

// Fetch technical advantages data
export const fetchTechnicalAdvantagesData =
  async (): Promise<TechnicalAdvantagesData> => {
    return fetchFromAPI(
      API_ENDPOINTS.TECHNICAL_ADVANTAGES,
      mockTechnicalAdvantagesData
    );
  };
...
export const updateCapabilitiesData = async (
...
export const updateConstructionProcessData = async (
...
export const updateTechnicalAdvantagesData = async (
...
export const checkProfileApiHealth = async (): Promise<{
  isHealthy: boolean;
  message: string;
}> => {
  try {
