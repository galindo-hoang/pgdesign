...
import BlogContentSection, {
  BlogContentSectionRef,
} from "../components/BlogContentSection";
import {
  createBlogPost,
  updateBlogPost,
  getBlogPost,
...
const BlogPostEditor: React.FC = () => {
  ...
  const handleAddKeyword = () => {
    if (
      newKeyword.trim() &&
      !postData.seoKeywords?.includes(newKeyword.trim())
    ) {
      setPostData((prev) => ({
        ...prev,
    ...
    if (file) {
      ...
      try {
        ...
        const response = await fetch(
          "https://be.pgdesign.vn/api/v1/upload/image",
          {
            method: "POST",
            body: formData,
          }
  ...
  const handleMetadataImagesChange = async (
    event: React.ChangeEvent<HTMLInputElement>
  ) => {
          ...
          <div className="editor-section">
            ...
            <div className="form-group">
              ...
              <div className="keywords-input-group">
                ...
                />
                <button className="add-keyword-btn" onClick={handleAddKeyword}>
                  <Plus />
                </button>
              </div>
            ...
            <div className="form-group">
              <div className="images-gallery">
                ...
                <label
                  ...
                  style={{ pointerEvents: uploadingImages ? "none" : "auto" }}
                >
                  {uploadingImages ? (
                    <div>Uploading...</div>
                  ) : (
